...
const Input: React.FC<InputProps> = ({ label, id, error, type = 'text', ...props }) => (
  <div className="mb-4">
    ...
    <input
      id={id}
      type={type}
      className={`w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200 ${error ? 'border-red-500' : ''
        }`}
