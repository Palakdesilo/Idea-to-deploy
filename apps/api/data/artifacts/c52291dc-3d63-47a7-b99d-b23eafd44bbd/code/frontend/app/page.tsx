  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 text-center">
        <h2 className="text-5xl font-bold text-gray-900 mb-6">A futuristic logistics platform for asteroid mining is the end-to-end digital brain that plans, coordinates, tracks, optimizes, and monetizes everything involved in extracting resources from asteroids and moving them to where they’re needed (orbit, Moon, Mars, or Earth).

Think of it as SpaceX + Maersk + AWS + Bloomberg, but for space resources.</h2>
