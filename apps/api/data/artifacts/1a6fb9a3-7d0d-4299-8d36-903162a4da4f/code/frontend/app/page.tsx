        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="animate-in fade-in slide-in-from-bottom-5 duration-700">
            ...
            <p className="text-xl text-foreground/60 mb-12 max-w-lg leading-relaxed">
              Build a customer support platform that allows users to submit support tickets, track status, communicate with support agents, and allows administrators to manage tickets, SLAs, and performance dashboards.
